...
namespace BaconGameJam6
{
    ...
    class Player
    {
        ...
        public void LoadContent()
        {
            ...
            idleAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/adIdle"), 0.1f, true);
            runAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/Run"), 0.1f, true);
            attackAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/quickAttack"), 0.3f, false);
            jumpAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/aJump"), 0.1f, false);
            celebrateAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/Celebrate"), 0.1f, false);
            dieAnimation = new Animation(Level.Content.Load<Texture2D>("Sprites/Player/dead"), 0.3f, false);
            ...
            DisplayOrientation orientation)
        {
            ...
            isAttacking = (gamePadState.IsButtonDown(AttackButton) || keyboardState.IsKeyDown(Keys.F)) && attackingTime != MaxAttackTime;
        }
        ...
        private void DoAttack(GameTime gameTime)
        {
            if(isAttacking)
            {
                ...
                if(attackingTime==MaxAttackTime)
                {
                    Console.WriteLine("Attack plays");
                }
                attackingTime = Math.Max(0.0f, attackingTime - (float)gameTime.ElapsedGameTime.TotalSeconds);
