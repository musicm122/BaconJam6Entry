...
namespace BaconGameJam6.GameStates
{
    //--------------------------------------------------------------------------
    internal class GameStateIntro : NuclearWinter.GameFlow.GameStateFadeTransition<PlatformerGame>
    {
        //----------------------------------------------------------------------
        private NuclearAnim.LerpValue mSwitchTimer;

        private NuclearAnim.AnimatedValue mMushroomAnim;
        private NuclearAnim.AnimatedValue mMushroomOpacityAnim;
        private NuclearAnim.AnimatedValue mLogoAnim;
        private NuclearAnim.AnimatedValue mTitleAnim;

        private Texture2D mMushroomTex;
        private Texture2D mTitleTex;
        private Texture2D mLogoTex;

        private Texture2D mSparklinLabsTex;

        private Random mRandom;

        //----------------------------------------------------------------------
        public GameStateIntro(PlatformerGame _game)
            : base(_game)
        {
        }
